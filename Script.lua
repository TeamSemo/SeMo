...
if Status or Dev_SeMo(msg) or Bot(msg) then  
return true  
else  
return false  
end  
...
if hash or Dev_SeMo(msg) or DeveloperBot(msg) or Bot(msg) then  
return true 
else 
return false 
end 
...
if hash or Dev_SeMo(msg) or DeveloperBot(msg) or PresidentGroup(msg) or Bot(msg) then     
return true    
else    
return false    
end 
...
if hash or Dev_SeMo(msg) or DeveloperBot(msg) or PresidentGroup(msg) or Constructor(msg) or Bot(msg) then     
return true    
else    
return false    
end 
...
if hash or Dev_SeMo(msg) or DeveloperBot(msg) or PresidentGroup(msg) or Constructor(msg) or Owner(msg) or Bot(msg) then     
return true    
else    
return false    
end 
...
if hash or Dev_SeMo(msg) or DeveloperBot(msg) or PresidentGroup(msg) or Constructor(msg) or Owner(msg) or Admin(msg) or Bot(msg) then     
return true 
else 
return false 
end 
...
url = 'https://raw.githubusercontent.com/SeMokid/SeMo/master/Script.lua'
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, FunctionStatus, nil)
elseif text == ("اضف مطور") and tonumber(msg.reply_to_message_id_) ~= 0 and Dev_SeMo(msg) then
local url,res = http.request('https://hso.mohammed-api.com/ApI_SeMo.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.SeMo ~= true then
send(msg.chat_id_,msg.id_,'\n⌔︙عليك الاشتراك في قناة البوت \n⌔︙قناة البوت ← { @Seemoo6 }')   
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, FunctionStatus, nil)
elseif text == ("حذف مطور") and tonumber(msg.reply_to_message_id_) ~= 0 and Dev_SeMo(msg) then
local url,res = http.request('https://hso.mohammed-api.com/ApI_SeMo.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.SeMo ~= true then
send(msg.chat_id_,msg.id_,'\n⌔︙عليك الاشتراك في قناة البوت \n⌔︙قناة البوت ← { @Seemoo6 }')   
...
tdcli_function ({ID = "SearchPublicChat",username_ = text:match("^الغاء العام @(.*)$") }, FunctionStatus, nil)
elseif text and text:match("^اضف مطور @(.*)$") and Dev_SeMo(msg) then
local url,res = http.request('https://hso.mohammed-api.com/ApI_SeMo.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.SeMo ~= true then
send(msg.chat_id_,msg.id_,'\n⌔︙عليك الاشتراك في قناة البوت \n⌔︙قناة البوت ← { @Seemoo6 }')   
...
tdcli_function ({ID = "SearchPublicChat",username_ = text:match("^اضف مطور @(.*)$")}, FunctionStatus, nil)
elseif text and text:match("^حذف مطور @(.*)$") and Dev_SeMo(msg) then
local url,res = http.request('https://hso.mohammed-api.com/ApI_SeMo.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.SeMo ~= true then
send(msg.chat_id_,msg.id_,'\n⌔︙عليك الاشتراك في قناة البوت \n⌔︙قناة البوت ← { @Seemoo6 }')   
...
elseif text and text:match("^حذف مطور (%d+)$") and Dev_SeMo(msg) then
local url,res = http.request('https://hso.mohammed-api.com/ApI_SeMo.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.SeMo ~= true then
send(msg.chat_id_,msg.id_,'\n⌔︙عليك الاشتراك في قناة البوت \n⌔︙قناة البوت ← { @Seemoo6 }')   
...
𓂅 . [Source Info ](t.me/SeMo0)     

𓂅 . [SeMo iNDT](t.me/SeMo0)     
 
 ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ 
𓂅 . [TWS SeMo](t.me/Ub55bot)     
]]) 
